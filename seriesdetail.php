...
<div class="container" >
			...
			<div id="projectNav">
				...
				<div id="projectNavList">
					<p style="font-size:100%; font-weight:bold; ">
						<?php $row=1; do {  ?>
					<p><a href="seriesdetail.php?sid=<?php echo $row_getseries['series_id']; ?>&amp;sst=<?php echo $row_getseries['series_sort']; ?>&amp;did=<?php echo $_GET['did']; ?>" class="seriesnav seriesButton" style="<?php if (($row_getseries['series_id'] == $_GET['sid']) OR ($_GET['did'] AND !$_GET['sid'] AND $row == 1)) { ?>color:#bd3535; padding-left:1px; padding-right:1px; padding-top:0px; padding-bottom:0px; margin-left:-1px; font-weight:bold;<?php } ?>font-size:130%;"><?php echo convert_smart_quotes($row_getseries['series_name']); ?></a></p>
	...
	<div class="repeatmainimageimagecontainer"> <a href="imagedetail.php?sid=<?php echo $_GET['sid']; ?>&amp;did=<?php echo $_GET['did']; ?>&amp;iid=<?php echo $row_getimagesall['image_id']; ?>&amp;sst=<?php echo $_GET['sst']; ?>&amp;skid=<?php echo $_GET['skid']; ?>" class="seriesButton2"> <img src="<?php if (!isset($_GET['sid'])) { ?>uploads/<?php echo convert_smart_quotes($row_getseriesimage['image_filename']); ?><?php } else { ?>uploads/<?php echo $row_getimagesall['image_filename']; ?><?php } ?>" id="mainimage" class="mainimage" /></a> </div>
	<?php } else { ?>
	<!-- If this is without series number -->
	<div class="repeatmainimageimagecontainer"> <a href="imagedetail.php?sid=<?php echo $_GET['sid']; ?>&amp;did=<?php echo $_GET['did']; ?>&amp;iid=<?php echo $row_getseriesimage['image_id']; ?>&amp;sst=<?php echo $_GET['sst']; ?>&amp;skid=<?php echo $_GET['skid']; ?>" class="seriesButton2"> <img src="<?php if (!isset($_GET['sid'])) { ?>uploads/<?php echo convert_smart_quotes($row_getseriesimage['image_filename']); ?><?php } else { ?>uploads/<?php echo $row_getseriesimage['image_filename']; ?><?php } ?>" id="mainimage" class="mainimage" /></a> </div>
	<br class="clear" />
	<?php } ?>
	<br class="clear" />
	<div id="titlearea">
		<p style="font-size:100%;width:220px;"> <a class="titleToDetailLink seriesButton2" href="imagedetail.php?sid=<?php echo $_GET['sid']; ?>&amp;did=<?php echo $_GET['did']; ?>&amp;iid=<?php echo $row_getimagesall['image_id']; ?>&amp;sst=<?php echo $_GET['sst']; ?>&amp;skid=<?php echo $_GET['skid']; ?>"> <?php echo $row_getimagesall['image_title']; ?>&nbsp; <span style="color:#000000;font-size:100%;font-weight:normal;"><?php echo $row_getimagesall['image_year']; ?></span> </a> </p>
	</div>
</div>
...
$(document).ready(function() {
	...
	function appendScrollPos(){
		...
		elements.each(function(){
			...
			henryV = <?php echo $_GET['skid']; ?>;
			<?php } ?>
			if( henryV != 0){
				crispin = crispin + "&skid=" + henryV;
			} else {
